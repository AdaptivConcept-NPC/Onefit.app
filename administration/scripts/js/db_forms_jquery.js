		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#community_group_members-form > #form-output-message").removeClass(
						"alert-info"
					);
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#exercises-form > #form-output-message").removeClass("alert-info");
					$("#exercises-form > #form-output-message").addClass("alert-success");
				} else {
					console.log("error: returning response - an error occurred");
					console.log("Response: " + response);
					/* pass error message output to ui */ $(
					...
					$("#exercises-form > #form-output-message").removeClass("alert-info");
					$("#exercises-form > #form-output-message").addClass("alert-danger");
				}
			},
			error: function (xhr, ajaxOptions, thrownError) {
				console.log(
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#followers-form > #form-output-message").removeClass("alert-info");
					$("#followers-form > #form-output-message").addClass("alert-success");
				} else {
					console.log("error: returning response - an error occurred");
					console.log("Response: " + response);
					/* pass error message output to ui */ $(
					...
					$("#followers-form > #form-output-message").removeClass("alert-info");
					$("#followers-form > #form-output-message").addClass("alert-danger");
				}
			},
			error: function (xhr, ajaxOptions, thrownError) {
				console.log(
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#indi_weekly_activities-form > #form-output-message").removeClass(
						"alert-info"
					);
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#post_media-form > #form-output-message").addClass("alert-danger");
				}
			},
			error: function (xhr, ajaxOptions, thrownError) {
				console.log(
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#team_weekly_activities-form > #form-output-message").removeClass(
						"alert-info"
					);
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#teams_weekly_schedules-form > #form-output-message").removeClass(
						"alert-info"
					);
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#user_conversation_messages-form > #form-output-message").addClass(
						"alert-success"
					);
				} else {
					console.log("error: returning response - an error occurred");
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#user_conversation_users-form > #form-output-message").removeClass(
						"alert-info"
					);
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#user_likes-form > #form-output-message").addClass("alert-danger");
				}
			},
			error: function (xhr, ajaxOptions, thrownError) {
				console.log(
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#user_policy_acceptance-form > #form-output-message").removeClass(
						"alert-info"
					);
...
$("#user_profile_fitness_stats_speed-form").on("submit", function (e) {
	e = e || window.event;
	e.preventDefault();
	var form_data = new FormData($("#user_profile_fitness_stats_speed-form")[0]);
	setTimeout(function () {
		$.ajax({
			type: "POST",
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#user_workout_achievements-form > #form-output-message").addClass(
						"alert-success"
					);
				} else {
					console.log("error: returning response - an error occurred");
		...
		$.ajax({
			...
			success: function (response) {
				if (response.startsWith("success")) {
					...
					$("#workouts-form > #form-output-message").removeClass("alert-info");
					$("#workouts-form > #form-output-message").addClass("alert-success");
				} else {
					console.log("error: returning response - an error occurred");
					console.log("Response: " + response);
					/* pass error message output to ui */ $(
