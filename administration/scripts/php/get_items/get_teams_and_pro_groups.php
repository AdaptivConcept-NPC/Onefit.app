...
try {
    // 
    $query = "SELECT * FROM `groups` WHERE (`group_category` = 'teams' OR `group_category` = 'pro') AND `administrators_username` = '$current_logged_admin' ORDER BY `creation_date` DESC";
