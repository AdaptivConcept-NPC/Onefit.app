  ...
  //Connection Test==============================================>
    ...
    if($result = mysqli_query($db,$sql)){
        ...
        if($usr_profilepicurl == "default"){
          $accountProdImg = '<img src="../media/assets/One-Symbol-Logo-White.png" class="img-fluid" style="border-radius: 25px;max-height:100px" alt="prof thumbnail">';
        }else if($usr_profilepicurl == ""){
          $accountProdImg = '<img src="../media/assets/One-Symbol-Logo-Black.png" class="img-fluid" style="border-radius: 25px;max-height:100px" alt="prof thumbnail">';
        }else{
...
<html lang="en">
  <head>
    ...
    <style>
      .nav-pills .nav-link {
        border-radius: 25px 25px 25px 0 !important; /*0.25rem*/
      }
      .btn-link {
        font-weight: 400;
  ...
  <body style="height: 100vh !important">
            ...
            <div class="row align-items-center py-4">
              <div class="col-lg-4 border-right border-white">
                ...
                <div class="nav flex-column nav-pills" id="v-create-pills-tab" role="tablist" aria-orientation="vertical">
                  <a class="nav-link text-truncate active" style="color: #fff; font-size: 20px" id="v-create-nw-post-tab" data-toggle="pill" href="#v-pills-nw-post-home" role="tab" aria-controls="v-pills-nw-post-home" aria-selected="true"><div class="px-4 text-center h-100" style="width: 100%; border-radius: 50rem 0; background: #333; border-bottom: #fff solid 5px;">New post</div></a>
                  <a class="nav-link text-truncate" style="color: #fff; font-size: 20px" id="v-create-nw-resource-tab" data-toggle="pill" href="#v-pills-nw-resource" role="tab" aria-controls="v-pills-nw-resource" aria-selected="false"><div class="px-4 text-center h-100" style="width: 100%; border-radius: 50rem 0; background: #333; border-bottom: #fff solid 5px;">Share resource</div></a>
                  <a class="nav-link text-truncate" style="color: #fff; font-size: 20px" id="v-create-nw-chat-tab" data-toggle="pill" href="#v-pills-nw-chat" role="tab" aria-controls="v-pills-nw-chat" aria-selected="false"><div class="px-4 text-center h-100" style="width: 100%; border-radius: 50rem 0; background: #333; border-bottom: #fff solid 5px;">Start a chat</div></a>
                  <a class="nav-link text-truncate" style="color: #fff; font-size: 20px" id="v-create-nw-fitblogpost-tab" onclick="openFitblogDesigner()" data-toggle="pill" href="#v-pills-nw-fitblogpost" role="tab" aria-controls="v-pills-nw-fitblogpost" aria-selected="false"><div class="px-4 text-center h-100" style="width: 100%; border-radius: 50rem 0; background: #333; border-bottom: #fff solid 5px;"><span style="color: #ffa500; -webkit-text-strokez: 0.5px #333;">fit</span>blog Article</div></a>
                  <a class="nav-link text-truncate" style="color: #fff; font-size: 20px" id="v-create-nw-grouppost-tab" data-toggle="pill" href="#v-pills-nw-grouppost" role="tab" aria-controls="v-pills-nw-grouppost" aria-selected="false"><div class="px-4 text-center h-100" style="width: 100%; border-radius: 50rem 0; background: #333; border-bottom: #fff solid 5px;">Post to group</div></a>
                </div>
              </div>
              <div class="col-lg-8">
    ...
    <div class="fitblog-post-designer-panel p-0" id="fitblog-post-designer">
      ...
      <div class="col-md mx-2 fitblog-designer-preview-window-container fitness-bgz bg-dark py-4" style="overflow-y: auto; border-radius: 25px;height: 100%;"> <!-- -->
          ...
          <div class="fitblog-designer-preview-window tunnel-bgz no-scroller shadow">
            <div class="text-center mt-4 p-2" id="main-item-heading-1-content-card">
              ...
              <div class="container-fluid" style="background: rgba(255,165,0,0.9);rgba(255,255,255,0.9);rgba(51,51,51, 0.7); border-radius: 25px; border-bottom: #333 solid 10px; border-left: #333 solid 10px;">
                <div class="row align-items-center">
                  <div class="col-md"><h1 class="p-4 text-dark" style="">Physical Heat Sync Training (A brand new concept for heat treatment)</h1></div>
        ...
        <div class="col-md mx-2 fitblog-designer-post-items-container no-scroller" style="overflow-y: auto; border-radius: 0 0 25px 25px;height: 100%;"> <!--height: 50%; -->
          <div class="sticky-topz container border-bottom border-left border-white shadow py-4" style="widthz:100%; z-index: 1101; background:#333; border-radius: 25px 0 25px 25px;">
            <div class="row align-items-center">
              <div class="col-2 p-0 h-100 text-center" style="width: 20%; overflow-y: visible; max-height: 60px">
                <button class="onefit-buttons-style p-3" onclick="closeFitblogDesigner()" type="button" data-toggle="collapse" data-target="#item-heading-1-input-container" aria-expanded="false" aria-controls="item-heading-1-input-container"><!--<i class="fas fa-door-open"></i>--><i class="fas fa-arrow-left"></i></button>
                
              </div>
              <div class="col-10 h-100" style="width: 80%">
                <h5 class="p-4 text-center" style="border-radius: 25px; border-left: #ffa500 solid 5px; border-right: #ffa500 solid 5px;"><img src="../media/assets/One-Logo-Vertical.png" class="img-fluid d-inline" style="max-height: 5vh;" alt="onefit logo"> | <span style="color:#ffa500">fit</span>blog</h5>
                
                <div class="row align-items-end">
                  <div class="col-sm text-left"><p style="font-size: 10px"><i class="fas fa-paint-brush"></i> Post Designer</p></div>
                  <div class="col-sm text-right"><button class="onefit-buttons-style p-3 mt-4z"><i class="fas fa-redo-alt"></i></button> | <button class="onefit-buttons-style p-3" type="button" data-toggle="collapse" data-target="#item-heading-1-input-container" aria-expanded="false" aria-controls="item-heading-1-input-container"><!--<i class="fas fa-door-open"></i>--><i class="fas fa-paper-plane"></i> Publish</button></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-1 px-0" style="background: #333; color: #fff; max-height: 100vh; overflow-y: auto">
        <ul class="nav nav-pills list-group bg-transparent border-0 navigation-bar" id="v-pills-navigation-tab" role="tablist" style="width: 100%; padding-top: 100px; padding-bottom: 50px;">
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link active p-1" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true" style="color: white">Home<!--<img src="../media/assets/icons/icons8-home-50.png" class="img-fluid" alt="Icons8 - Home icon" />--></a>
          </li>
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link p-1" id="v-pills-dashboard-tab" data-toggle="pill" href="#v-pills-dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="false" style="color: white">Dashboard<!--<img src="../media/assets/icons/icons8-line-chart-50.png" class="img-fluid" alt="Icons8" />--></a>
          </li>
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link p-1" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false" style="color: white">Profile<!--<img src="../media/assets/icons/icons8-name-tag-50.png" class="img-fluid" alt="Icons8 - contacts icon" />--></a>
          </li>
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link p-1" id="v-pills-discover-tab" data-toggle="pill" href="#v-pills-discover" role="tab" aria-controls="v-pills-discover" aria-selected="false" style="color: white">Discover<!--<img src="../media/assets/icons/icons8-connect-50.png" class="img-fluid" alt="Icons8 - connect icon" />--></a>
          </li>
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link p-1" id="v-pills-activities-tab" data-toggle="pill" href="#v-pills-activities" role="tab" aria-controls="v-pills-activities" aria-selected="false" style="color: white">Activities<!--<img src="../media/assets/icons/icons8-check-all-50.png" class="img-fluid" alt="Icons8 - check all icon" />--></a>
          </li>
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link p-1" id="v-pills-tracking-tab" data-toggle="pill" href="#v-pills-tracking" role="tab" aria-controls="v-pills-tracking" aria-selected="false" style="color: white">Tracking<!--<img src="../media/assets/icons/icons8-binoculars-50.png" class="img-fluid" alt="Icons8 - binoculars icon" />--></a>
          </li>
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link p-1" id="v-pills-fitblog-tab" data-toggle="pill" href="#v-pills-fitblog" role="tab" aria-controls="v-pills-fitblog" aria-selected="false" style="color: white">fitblog<!--<img src="../media/assets/icons/icons8-for-you-50.png" class="img-fluid" alt="Icons8 - for you icon" />--></a>
          </li>
          <li class="nav-item list-group-item bg-transparent border-0 text-center p-0">
            <a class="nav-link p-1" id="v-pills-communication-tab" data-toggle="pill" href="#v-pills-communication" role="tab" aria-controls="v-pills-communication" aria-selected="false" style="color: white">Communication<!--<img src="../media/assets/icons/icons8-communication-50.png" class="img-fluid" alt="Icons8 - news icon" />--></a>
          </li>
        ...
        <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="row ">
                ...
                <div class="col-lg border-left border-white">
                  ...
                  <div class="twitter-social-container">
                    <a class="twitter-timeline" href="https://twitter.com/OnefitNet?ref_src=twsrc%5Etfw">Tweets by OnefitNet</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                  </div>
                </div>
              </div>
          ...
          <div class="tab-pane fade py-4 pl-2 pr-0" id="v-pills-discover" role="tabpanel" aria-labelledby="v-pills-discover-tab">
            ...
            <div class="tab-content" id="nav-tabContent-discover">
              <div class="tab-pane fade show active" id="discover-nav-people" role="tabpanel" aria-labelledby="discover-nav-people-tab"><div class="grid-container"><?php echo $discoverPeopleList; ?></div></div>
              ...
              <div class="tab-pane fade" id="discover-nav-groups" role="tabpanel" aria-labelledby="discover-nav-groups-tab"><div class="grid-container"><?php echo $discoverGroupsList;?></div></div>
              <div class="tab-pane fade" id="discover-nav-resources" role="tabpanel" aria-labelledby="discover-nav-resources-tab"><div class="grid-container"><?php echo $discoverResourcesList;?></div></div>
              <div class="tab-pane fade" id="discover-nav-programs" role="tabpanel" aria-labelledby="discover-nav-programs-tab"><div class="grid-container"><?php echo $discoverProgramsList;?></div></div>
            </div>
          </div>
          <!--Activities tab-->
              ...
              <div class="text-left">
                ...
                <ul class="list-group list-group-flush p-0 m-0">
                  <li class="list-group-item bg-transparent px-0">
                    <div class="py-4 text-truncate" id=""><!--<i class="fas fa-chevron-right"></i> <span id="">16:12</span> | <span id="">blah blah blahiiiiiiiiiiiiiiiiiiiii oooooooooooooooooooooooooooo nnnnnnnnnnnnnnnnnnnnnnnnnn jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj</span>--> No activities</div>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-lg" style="max-height: 70vh; overflow-y: auto">
                  ...
                  <div class="text-center my-2">
                    <hr class="bg-white">
                    <img src="../media/assets/One-Symbol-Logo-White.png" class="img-fluid" style="max-height: 50px" alt="end of feed">
                  </div>
                </div>
