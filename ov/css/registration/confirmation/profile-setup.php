            ...
            <div class="col-md-8">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center tunnel-bg m-4 py-2" style="border-radius: 25px">
                        ...
                        <div class="col-lg -8">
                            <div class="text-center" style="font-size: 50px; font-family: 'MuseoModerno', cursive">
                                <!--<?php echo $usrprof_name . ' ' . $usrprof_surname . ' <span id="" class="profile-username-tag" style="font-size: 25px">@' . $usrprof_username . '</span>'; ?>-->
                            </div>
                            <hr class="bg-white">
