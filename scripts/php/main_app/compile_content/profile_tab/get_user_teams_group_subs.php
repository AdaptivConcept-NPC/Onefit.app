...
//Declaring variables
$teamsSubsGroupsList = $app_err_msg = $output = null;
...
function getTeamsGroupSubs()
{
  // declaring variables
  global $dbconn;
  global $currentUser_Usrnm, $teamsSubsGroupsList, $app_err_msg, $output;
