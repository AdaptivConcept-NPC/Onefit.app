...
try {
    //groups
    $sql = "SELECT * FROM groups WHERE group_category = 'teams' ORDER BY group_id DESC";
        ...
        for ($j = 0; $j < $rows; ++$j) {
            ...
            <li id="group-item-$grps_groupid-$grps_refcode" class="list-group-item list-group-item-action d-flex gap-4 justify-content-between align-items-center left-right-grad-white-mineshaft" style="border-radius:25px;">
                ...
                <div class="d-grid gap-2">
                    ...
                    <button class="onefit-buttons-style-dark p-4" type="button" onclick="viewGroup('$grps_refcode','teams')">
            ...
            <div class="col-md-8 light-scroller" style="max-height:100vh;overflow-y:auto;">
                ...
                <div class="h-100 w-100 d-grid align-items-center justify-content-center">
                    <h5 class="text-center d-grid gap-2">
                        <span class="material-icons material-icons-outlined align-middle text-muted" style="font-size:100px!important;">diversity_2</span>
...
/* <<<_END
<div class="grid-tile px-2 mx-0 content-panel-border-style my-4 d-none" id="group-card-$grps_groupid-$grps_refcode">
