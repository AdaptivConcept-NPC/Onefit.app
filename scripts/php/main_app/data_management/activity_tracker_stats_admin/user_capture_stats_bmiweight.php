...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        (`fitness_stats_bmi_id`, `workout_activity`, `datasource`, `bmi`, `date`, `time`, `user_profiles_user_profile_id`, `exercises_exercise_id`)
        VALUES 
        (null,'$weight_workout','$weight_datasource','$weight_value','$dateNow','$timeNow',$user_profile_id,$weight_workout)";
        ...
        //throw $th;
        echo "exception error: [weight Except Err_01] " . $th;
    }
}
